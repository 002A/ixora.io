...
BLOG_AUTHOR = "Jim"  # (translatable)
BLOG_TITLE = "ixora.io"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://ixora.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://ixora.io/"
BLOG_EMAIL = "jim@ixora.io"
...
DEPLOY_COMMANDS = {
    'default': [
        "rsync -rlv --exclude '.git' --exclude '*~'  --delete output/ jim@ixora:/var/www/html",
    ]
}
